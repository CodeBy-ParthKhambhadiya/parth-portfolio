...
export default function Sidebar() {
  return (
    <div className="fixed top-1/2 left-4 transform -translate-y-1/2 flex flex-col gap-4 z-50">
      ...
      <Link href="/blog" className="group relative flex items-center justify-center w-12 h-12 rounded-full bg-gray-200 hover:bg-gray-300 transition">
        <FaBlog size={20} />
        <span className="absolute left-full ml-2 px-3 py-1 rounded bg-gray-800 text-white opacity-0 group-hover:opacity-100 group-hover:left-14 whitespace-nowrap transition-all duration-300">
          Blog
        </span>
      ...
      {/* Social Links */}
      <Link href="https://github.com/your-username" target="_blank" className="group relative flex items-center justify-center w-12 h-12 rounded-full bg-gray-800 text-white hover:bg-gray-900 transition">
        <FaGithub size={20} />
        <span className="absolute left-full ml-2 px-3 py-1 rounded bg-gray-800 text-white opacity-0 group-hover:opacity-100 group-hover:left-14 whitespace-nowrap transition-all duration-300">
          GitHub
        </span>
      ...
      <Link href="https://www.linkedin.com/in/your-username" target="_blank" className="group relative flex items-center justify-center w-12 h-12 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition">
        <FaLinkedin size={20} />
        <span className="absolute left-full ml-2 px-3 py-1 rounded bg-gray-800 text-white opacity-0 group-hover:opacity-100 group-hover:left-14 whitespace-nowrap transition-all duration-300">
          LinkedIn
        </span>
      ...
      <Link href="mailto:your-email@example.com" className="group relative flex items-center justify-center w-12 h-12 rounded-full bg-red-500 text-white hover:bg-red-600 transition">
        <FaEnvelope size={20} />
        <span className="absolute left-full ml-2 px-3 py-1 rounded bg-gray-800 text-white opacity-0 group-hover:opacity-100 group-hover:left-14 whitespace-nowrap transition-all duration-300">
          Email
        </span>
